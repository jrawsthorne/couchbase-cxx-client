 ...
 */
enum class error_map_attribute {
    /**
...
struct error_map {
    ...
    struct error_info {
        ...
        std::set<error_map_attribute> attributes;

        [[nodiscard]] bool has_retry_attribute() const
        {
            return attributes.find(error_map_attribute::retry_now) != attributes.end() ||
                   attributes.find(error_map_attribute::retry_later) != attributes.end();
        }
    };
